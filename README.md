...
- длина (более 12),
- наличие любых специальных символов.
...
Выше перечисленные функции также используют встроенную фцнкцию `any`, которая имеет два значения `True` или `False`, возвращая их при выполнении или невыполнении элементом пароля условия данной функции.
В конце функция `main()` подведет итоги и выведет итоговую оценку вашего пароля от 0 до 10, соответственно это значение показывает то, насколько ваш пароль безопасен.
